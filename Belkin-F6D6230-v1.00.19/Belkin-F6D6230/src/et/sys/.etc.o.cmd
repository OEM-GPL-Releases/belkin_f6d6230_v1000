cmd_drivers/net/et/../../../../../et/sys/etc.o := mipsel-linux-gcc -Wp,-MD,drivers/net/et/../../../../../et/sys/.etc.o.d  -nostdinc -isystem /opt/toolchain/hndtools-mipsel-linux-uclibc-4.1.2-32/bin/../lib/gcc/mipsel-linux-uclibc/4.1.2/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -I../../include -DBCMINTERNAL -DBCMDBG -DBCMDRIVER -Dlinux -O2  -mabi=32 -G 0 -mno-abicalls -fno-pic -pipe -msoft-float -ggdb -ffreestanding  -march=mips32r2 -Wa,-mips32r2 -Wa,--trap  -Iinclude/asm-mips/mach-generic -fomit-frame-pointer  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign -DCFG_GMAC -DBCM47XX_CHOPS -DETROBO -DETADM -DBCMDMA64 -DBCMDMA32 -DDMA -Werror -Idrivers/net/et/../../../../../et/sys  -DMODULE -mlong-calls -fno-common -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(etc)"  -D"KBUILD_MODNAME=KBUILD_STR(et)" -c -o drivers/net/et/../../../../../et/sys/.tmp_etc.o drivers/net/et/../../../../../et/sys/etc.c
