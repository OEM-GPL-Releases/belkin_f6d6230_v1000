 ...
 *
 * $Id: bcmsrom.c,v 1.166.2.102 2009/07/16 10:11:46 Exp $
 */
...
#if defined(USB4322) || defined(USB4319)
...
static char BCMNMIATTACHDATA(vstr_cckdigfilttype)[] = "cckdigfilttype=%d";
