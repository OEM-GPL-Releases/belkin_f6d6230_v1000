...
#define DEFAULT_AUTH_FILE "/tmp/l2tpd/l2tp-secrets"
#define ALT_DEFAULT_AUTH_FILE "/tmp/l2tp/l2tp-secrets"
#define DEFAULT_CONFIG_FILE "/tmp/l2tpd/l2tpd.conf"
#define ALT_DEFAULT_CONFIG_FILE "/tmp/l2tp/l2tpd.conf"
