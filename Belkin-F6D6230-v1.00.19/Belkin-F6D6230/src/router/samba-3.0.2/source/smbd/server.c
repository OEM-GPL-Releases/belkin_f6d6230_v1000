 ...
 int main(int argc,const char *argv[])
{
	...
	//DEBUG(2, ("smbd main server.c line 805\n"));
#if HAVE_SETPGID
	/*
...
#endif
	//DEBUG(2, ("smbd main server.c line 814\n"));
	if (!directory_exist(lp_lockdir(), NULL))
		mkdir(lp_lockdir(), 0755);
	//DEBUG(2, ("smbd main server.c line 817\n"));
	if (is_daemon)
		pidfile_create("smbd");
	//DEBUG(2, ("smbd main server.c line 820\n"));
	/* Setup all the TDB's - including CLEAR_IF_FIRST tdb's. */
	if (!message_init())
		exit(1);
	//DEBUG(2, ("smbd main server.c line 824\n"));
	if (!session_init())
		exit(1);
	//DEBUG(2, ("smbd main server.c line 827\n"));
	if (conn_tdb_ctx() == NULL)
		exit(1);
	//DEBUG(2, ("smbd main server.c line 830\n"));
	if (!locking_init(0))
		exit(1);
	DEBUG(2, ("smbd main server.c line %d\n", __LINE__));
	...
	*/
	...
	{
		DEBUG(2, ("ERROR: Samba cannot open socket.\n"));
		exit(1);
	}
