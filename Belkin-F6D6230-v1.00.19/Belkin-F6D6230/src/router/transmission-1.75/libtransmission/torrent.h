 ...
 *
 * $Id: torrent.h 9131 2009-09-17 03:24:35Z charles $
 */
...
#ifdef TR_SEEDTIME
void             tr_torrentCheckSeedTime( tr_torrent * tor );
#endif

#ifdef TR_DCTCS
void             tr_torrentSetSrcFilename( tr_torrent * tor, const char * fileName );

const char *     tr_torrentGetSrcFilename( tr_torrent * tor);
#endif
...
#if 0 // def TR_DCTCS
    // tr_torrent_time_limit_hit_func * time_limit_hit_func;
    // void *                     time_limit_hit_func_user_data;
#endif
...
#ifdef TR_SEEDTIME
    tr_seedtimelimit           seedTimeLimitMode;
#endif
